  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: FutureBuilder<QuerySnapshot>(
          future: firestore.collection('medicine').get(),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        Text(
                          "Resep Obat Diterima Dari ${prescription.namaDokter}",
                          style: TextStyle(
                  ...
                  Container(
                      ...
                      child: Text(
                        'HARAP DIBACA SEBAGAI PANDUAN PENGGUNAAN OBAT!',
                        style: TextStyle(
                  ...
                  Container(
                      padding: EdgeInsets.only(left: 25.0, right: 25.0),
                      child: Text(
                        'Silahkan Mengisi Alamat Penerima Dengan BENAR',
                        style: TextStyle(
                            color: Colors.red, fontWeight: FontWeight.bold),
                        textAlign: TextAlign.center,
                      )),
