...
class PickUp extends StatefulWidget {
  ...
  PickUp({Key key, this.prescription, this.medicineName, this.pharmacyName, this.pharmacyId, this.medicineQty}) : super(key: key);
        ...
        body: Column(
          children: <Widget>[
            Container(
              ...
              child: Text('Silahkan Memilih Farmasi Sebagai Tempat Untuk Anda Menebus Obat',
            ...
            child: ListView.builder(
              ...
              return GestureDetector(
                onTap: (){
                  ...
                  PatRecap(prescription: widget.prescription, medicineName: widget.medicineName,
                  medicineQty: widget.medicineQty,
                  pharmacyName: _pharmacy[index].instansiPelayanan,
                  pharmacyId: _pharmacy[index].idFarmasi, pharmacyPhone: _pharmacy[index].nomorTelepon)),);
                },
                child: Container(
                  height: 50,
                    child: Card(
                      ...
                      child: Center(child: Text("${_pharmacy[index].instansiPelayanan}",
